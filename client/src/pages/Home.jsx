    ...
    return(
      <main className="grid w-full grid-cols-1">
          ...
          <section className="HERO text-custom-dark-green px-4 my-10 flex h-screen flex-col items-center justify-center">
              ...
              <a href="#" className="bg-custom-dark-brown text-white font-bold py-3 px-8 rounded-xl">sign up</a>
          </section>

          <span class="block h-0.5 w-full bg-slate-950"></span>

          <section className="FEATURES">
              <article className="bg-custom-md-green text-custom-dark-green py-20 flex flex-col items-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3">
                ...
                <article className="CURATE-DASH flex h-96 flex-col items-center justify-center">
          ...
          <section className="CTA h-96 flex flex-col items-center justify-center">
              ...
              <div className="LINKS flex flex-col">
                <NavLink to={"/sign-up"} className="bg-custom-dark-brown rounded-lg text-white py-4 px-8 mb-4 text-center">Sign up for free</NavLink>
                <NavLink to={"/login"} className="bg-custom-dark-brown rounded-lg text-white p-4 px-8 text-center">Login</NavLink>
              </div>
          </section>
